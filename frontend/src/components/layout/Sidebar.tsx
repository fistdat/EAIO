        ...
        <div className="h-full flex flex-col">
          <div className="p-4 border-b border-gray-200">
            <div className="flex items-center justify-center py-2">
              ...
              <span className="ml-2 text-xl font-semibold text-gray-900">EAI Optimizer</span>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-900">Energy Manager</p>
                <p className="text-xs font-medium text-gray-500">Facility Manager</p>
              </div>
            </div>
          </div>
        </div>
